1. 一对一：关联字段OneToOneField可以定义在任意一个模型中。
 ...
 calss B:
 	...
 	c = OneToOneField(A, null=True,on_delete=CASCADE,relate_name='d')
...
"""
 ...
 calss B:
 	...
 	c = ForeignField(A, null=True,on_delete=CASCADE,relate_name='d')
...
```
 ...
 calss B:
 	...
 	c = ManyToManyField(A, null=True,on_delete=CASCADE,relate_name='d')
